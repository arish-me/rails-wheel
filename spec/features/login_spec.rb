...
RSpec.feature 'Navbar and Authentication', type: :feature do
  ...
  scenario 'User navigates from home to sign in page and attempts authentication', :js do
    # Visit the root path
    visit root_path
    ...
    create(:user_with_default_role, email: 'test@example.com', password: 'password123')
