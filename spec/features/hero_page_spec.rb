...
RSpec.feature 'Hero Page', type: :feature do
  scenario 'User visits the hero page and sees all sections', :js do
    visit root_path
  ...
  scenario "User clicks the 'Get Started' button and is taken to sign up page", :js do
    visit root_path
  ...
  scenario "User clicks 'Learn More' and page scrolls to features section", :js do
    visit root_path
